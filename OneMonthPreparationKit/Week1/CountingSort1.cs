...
namespace HackerRank.OneMonthPreparationKit.Week1
{
    public class CountingSort1
        : Challenge<List<int>, List<int>>
    {
        protected override List<int> Run(List<int> arr)
        {
        ...
        public override IEnumerable<(List<int> input, List<int> expectedResult)> TestCases()
        {
            return new List<(List<int> input, List<int> expectedResult)>
            {
                (
                    new List<int>
                    {
